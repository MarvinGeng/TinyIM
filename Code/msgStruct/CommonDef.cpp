...
std::string MsgType(const MessageType& msgType)
{
	switch (msgType)
	{
		...
		ENUM_TO_STRING(MessageType::UpdateGroupListNotifyRsp_Type)
		ENUM_TO_STRING(MessageType::UdpP2PStartReq_Type)
		ENUM_TO_STRING(MessageType::UdpP2PStartRsp_Type)
		ENUM_TO_STRING(MessageType::QueryUserUdpAddrReq_Type)
		ENUM_TO_STRING(MessageType::QueryUserUdpAddrRsp_Type)
		ENUM_TO_STRING(MessageType::GetFriendChatHistroyReq_Type)
		ENUM_TO_STRING(MessageType::GetFriendChatHistoryRsp_Type)
		ENUM_TO_STRING(MessageType::GetGroupChatHistoryReq_Type)
		ENUM_TO_STRING(MessageType::GetGroupChatHistoryRsp_Type)
		ENUM_TO_STRING(MessageType::SearchChatMsgReq_Type)
		ENUM_TO_STRING(MessageType::SearchChatMsgRsp_Type)
		ENUM_TO_STRING(MessageType::AsyncFriendChatMsgReq_Type)
		ENUM_TO_STRING(MessageType::AsyncFriendChatMsgRsp_Type)
		ENUM_TO_STRING(MessageType::AsyncGroupChatMsgReq_Type)
		ENUM_TO_STRING(MessageType::AsyncGroupChatMsgRsp_Type)
		ENUM_TO_STRING(MessageType::FileSendDataBeginReq_Type)
		ENUM_TO_STRING(MessageType::FileSendDataBeginRsp_Type)
	default:
		{
			return "UNKNOWN";
		}break;
