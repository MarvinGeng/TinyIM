...
#ifndef _FILE_TRANSFER_CTRL_H_
#define _FILE_TRANSFER_CTRL_H_
...
public:
	...
	BOOL SetFileItemRequestByID(long nID, C_WND_MSG_FileItemRequest* pFileItemRequest);
	C_WND_MSG_FileItemRequest* GetFileItemRequestByID(long nID);
	C_WND_MSG_FileItemRequest* GetFileItemRequestByIndex(size_t nIndex);
