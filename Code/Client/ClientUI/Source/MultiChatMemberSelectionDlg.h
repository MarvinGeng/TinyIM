...
/**
 * @file MultiChatMemberSelectionDlg.h
 ...
 * 
 */
#ifndef _DENNIS_THINK_C_MULTI_CHAT_MEMBER_SELECTION_DLG_H_
#define _DENNIS_THINK_C_MULTI_CHAT_MEMBER_SELECTION_DLG_H_
#include <set>
#include "resource.h"
...
public:
	...
	BEGIN_MSG_MAP_EX(CMultiChatMemberSelectionDlg)
		...
		NOTIFY_HANDLER_EX(IDC_TREE_MEMBER_LIST, TVN_SELCHANGED, OnBuddyTreeSelectedChanged)
