...
#ifndef _DENNIS_THINK_SESS_CHAT_DLG_H_
#define _DENNIS_THINK_SESS_CHAT_DLG_H_
...
private:
	...
	void AddMsg(C_UI_SessMessage* lpSessMsg);
	...
	void AddMsgToRecvEdit(C_UI_SessMessage* lpSessMsg);
...
private:
	...
	CSkinButton m_btnArrow;
	CSkinMenu m_SkinMenu;
	CSkinToolBar m_tbTop;
	CSkinToolBar m_tbMid;
	CFaceSelDlg m_FaceSelDlg;
	CFontSelDlg m_FontSelDlg;
	CPicBarDlg m_PicBarDlg;
	CSkinRichEdit m_richRecv;
	CSkinRichEdit m_richSend;
