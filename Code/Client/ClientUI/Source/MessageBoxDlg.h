 ...
 * 
 */
#ifndef _DENNIS_THINK_C_MESSAGE_DLG_H_ 
#define _DENNIS_THINK_C_MESSAGE_DLG_H_
#include "resource.h"
#include "SkinLib/SkinLib.h"

//退出提示对话框
class CMessageBoxDlg : public CDialogImpl<CMessageBoxDlg>
{
public:
	CMessageBoxDlg();
	...
	BEGIN_MSG_MAP_EX(CMessageBoxDlg)
